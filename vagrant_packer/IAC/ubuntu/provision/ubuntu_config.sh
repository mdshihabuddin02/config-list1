...
java -jar jenkins-cli.jar -s http://localhost:8080/ -auth admin:INITIAL_ADMIN_PASSWORD create-user --username jenkins --password 123 --fullname "jenkins" --email jenkins@gmail.com
